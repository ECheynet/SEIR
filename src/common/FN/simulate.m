function [Y] = simulate(alpha, beta, gamma, delta, lambda0, kappa0, tau0, rho, Y, Npop, t)
    N = numel(t);
    dt = median(diff(t));
    ...
    for i=1:N-1
        interactions = [alpha, gamma, delta, lambda(i), kappa(i), tau(i), rho];  % pack coefficients
